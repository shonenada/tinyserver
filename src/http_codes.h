...
// and is terminated by an empty line. There are no required headers for
...
// and its client has been closed, or unless the proxy itself requested
...
// the response is dependent on the method used in the request, for example:
...
// given by a Location header field. The response SHOULD include
// an entity containing a list of resource characteristics and location(s)
// from which the user or user agent can choose the one most appropriate.
// The entity format is specified by the media type given in the
// Content-Type header field. The origin server MUST create the resource
...
// given of whether the condition is temporary or permanent. The 4(Gone)
...
//
// The 4response is primarily intended to assist the task of web maintenance
...
// MAY try again.
#define CODE_413 "Request Entity Too Large"
...
#define CODE_414 "Request-URI Too Long"
...
#define CODE_416 "Requested Range Not Satisfiable"
